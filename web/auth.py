...
def verify_credentials(username, password):
    ...
    # Иначе сравниваем как plain (первый запуск)
...
def update_credentials(new_username, new_password):
    ...
    try:
        ...
        for line in lines:
            ...
            if line.startswith("ADMIN_USER="):
                ...
                out_lines.append("ADMIN_USER=" + new_username)

                seen_user = True

            elif line.startswith("ADMIN_PASSWORD="):

                out_lines.append("ADMIN_PASSWORD=" + hashed)
        ...
        return False, "Ошибка записи: " + str(e)
